...
const width = 4;
let squares = [];
let colors = ["#CFB284", "#B85C38", "#5C3D2E", "#2D2424","#CF0000","#890596","#1CC5DC","#FDCA40","#FB3640","#7ECA9C","#9EDE73"];
let whiteColor = "#fff";
...
// function to check if combination is possible
const checkNumbersCombination = () => {
    ...
    console.log('Combinations Left: '+combinationsCount)
    return combinationsCount > 0 ? true : false;
}
...
const checkForLoss = () => {
    ...
    if (zerosCount === 0) {
        let isCombinationLeft = checkNumbersCombination();
        console.log('Combination Left: '+isCombinationLeft);
        if (!isCombinationLeft) {
